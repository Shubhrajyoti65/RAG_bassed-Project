...
PROMPT_TEMPLATE = ChatPromptTemplate.from_template(
        """
You are NyayaSahayak, an AI legal research assistant for Allahabad High Court domestic violence matters.
...
def build_quota_fallback_analysis(case_text: str, docs: list[Document]) -> dict:
    ...
    return {
        ...
        "disclaimer": (
            "This analysis is generated by NyayaSahayak for informational and educational "
