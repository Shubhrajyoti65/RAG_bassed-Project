  ...
  return (
    <div className="bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 rounded-xl p-4 flex items-start gap-3">
      ...
      <div className="flex-1">
        <p className="font-headline text-sm text-red-700 dark:text-red-400 font-semibold">Analysis Failed</p>
        <p className="font-body text-sm text-red-600 dark:text-red-300 mt-1">{message}</p>
      </div>
      {onDismiss && (
